...
public class Lists
{
    ...
    private JTextField playerAvgMinutes;
    ...
    private void makeContent()
    {
        ...
        //playerName.setBackground(Color.RED); Extra line for background for experiment, not part of main project
        ...
        avgMinutesLabel = new JLabel("Average Minutes Played per Game:");
        avgMinutesLabel.setFont(new Font("Trebuchet MS",Font.BOLD + Font.ITALIC,14));
        panel.add(avgMinutesLabel);
        playerAvgMinutes = new JTextField();
        playerAvgMinutes.setFont(new Font("Trebuchet MS",Font.PLAIN,14));
        playerAvgMinutes.setForeground(Color.BLUE);
        panel.add(playerAvgMinutes);
        ...
        public void actionPerformed(ActionEvent ae)
        {
           ...
           map = new TreeMap<Integer, Player>();
            ...
            while (scan.hasNext())
            {
                ...
                //added double to complile 
                double avgMinutes = scan.nextDouble();
                map.put(new Integer(nbr),
                new Player(name, nbr, position, avgPoints, avgRebounds, avgAssists, avgMinutes));
            }
    ...
    private void getPlayer(Player p)
        {
            ...
            playerAvgMinutes.setText("" + p.getAvgMinutes());
        }
